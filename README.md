...
Descriptions
We learned how to build a basic classifier to identify PET vs MRI images. Recall from the lectures we can have variations in the contrast of the MRI utilizing T1 and T2 weighted signals. In this project we ask you to adopt the notebook: xx and build a CNN model that can classify T1 and T2 MRI images. As part of this exercise, we want you to submit report in google doc/pdf of the following
